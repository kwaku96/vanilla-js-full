...
const fiften = inventors.filter(inventor => {
...
const oldInventor = inventors.sort((a,b)=>{
    const first = a.passed - a.year;
    const second = b.passed - b.year;

    return first > second ? -1 : 1;
});
console.table(oldInventor)

/*
const category = document.querySelector('.mw-category');
const links = category.querySelectorAll('a');

const arlinks = Array.from(links);

const linksNames = arlinks
